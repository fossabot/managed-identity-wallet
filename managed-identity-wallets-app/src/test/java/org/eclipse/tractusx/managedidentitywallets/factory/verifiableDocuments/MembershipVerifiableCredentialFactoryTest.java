...
public class MembershipVerifiableCredentialFactoryTest extends MiwTestCase {

    @Autowired
    public MembershipVerifiableCredentialFactory factory;
    ...
    public void testContextSet() {
        ...
        final VerifiableCredential verifiableCredential = factory.createMembershipVerifiableCredential(wallet);

        final boolean containsBpnContext =
                verifiableCredential.getContext()
                        .contains(verifiableCredentialContextConfiguration.getMembershipVerifiableCredentialContext());
