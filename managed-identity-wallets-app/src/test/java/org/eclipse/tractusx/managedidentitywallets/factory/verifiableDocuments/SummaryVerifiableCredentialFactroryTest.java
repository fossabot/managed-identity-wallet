...
public class SummaryVerifiableCredentialFactroryTest extends MiwTestCase {
    ...
    public void testContextSet() {
        ...
        final VerifiableCredential verifiableCredential = factory.createSummaryVerifiableCredential(wallet);

        final boolean containsBpnContext =
                verifiableCredential.getContext()
                        .contains(verifiableCredentialContextConfiguration.getSummaryVerifiableCredentialContext());
