...
public class FrameworkVerifiableCredentialFactoryTest extends MiwTestCase {
    ...
    public void testContextSet() {
        ...
        final VerifiableCredential verifiableCredential = factory.createFrameworkVerifiableCredential(wallet,
                verifiableCredentialType, "http://localhost/template", "1.0.0");

        final boolean containsBpnContext =
                verifiableCredential.getContext()
                        .contains(verifiableCredentialContextConfiguration.getFrameworkVerifiableCredentialContext());
