...
public class PostSignedVerifiablePresentationUserApiHandlerTest extends RestAssuredTestCase {
    ...
    @Test
    public void testVerifiablePresentationIssuingSuccess() {
        ...
        given()
                ...
                .body(payload)
                .when()
                .post("/api/v2/signed-verifiable-presentations")
                .then()
                .statusCode(200)
                .log().all()
